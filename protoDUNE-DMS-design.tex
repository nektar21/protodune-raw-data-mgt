...
Other comments:
\begin{itemize}
\item This diagram assumes that there is no difference between NP02 and NP04 in terms of the general pattern of data flow.
...
\subsection{Note on the file size}
At the time of writing, the raw data file size is assumed to be 4\,GB.
