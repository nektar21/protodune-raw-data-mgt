...
\item An assumption that a data transfer system won't be needed for the operation of prompt
processing since the data will be read from and written to CERN EOS

\item The workflow and its elements can be modeled as a DAG (\ref{sec:dag}).
